...
//
// openurma::ls::NIC — facade for the §8.3 Load/Store + TP Bypass
// topology variant. Same port surface as openurma::sc::NIC.

#ifndef OPENURMA_LS_SC_FACADE_HPP
#define OPENURMA_LS_SC_FACADE_HPP
